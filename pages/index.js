    ...
    <>
      ...
      <Container>
        ...
        <Box style={{ marginTop: '60px' }}>
          <Text>
            Entusiasta, estudante e interessado sobre o mundo Front-end e tecnologias em geral, buscando sempre novos conhecimentos e tentando exercê-los na prática. Admirador de animações e transições em css e javascript. Conheça mais <Link href='./sobre'>sobre mim</Link>
          </Text>
          <Box style={{ marginTop: '60px' }}>
